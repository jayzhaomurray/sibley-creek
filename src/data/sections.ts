...
export const sections: Section[] = [
  ...
  },
  {
    ...
    abstractCitations: [
      ...
      { phrase: "bond issuance planned at a record", source: "pipeline:frt_issuance_flow_total", note: "Materialized slot: FY2025-26 plan total $612B vs prior series peak $590B (FY2020-21 actual). Plan-attributed superlative per §4.1k — outturn unpublished." },
      ...
      { phrase: "holds flat near 41% of GDP", source: "pipeline:fiscal:panel-9", note: "fiscal.json panel-9 frt_federal_debt_pct_gdp: 41.1% FY2025-26 to 41.6% FY2030-31 (forecast-stable, DoF track; plan-attributed in prose per §4.1k)." },
