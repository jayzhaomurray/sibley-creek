...
export const sections: Section[] = [
  ...
  },
  {
    ...
    blurb: {
      ...
      date: "Jun 4, 2026",
      body:
        "The fiscal stance is mildly expansionary and stays in deficit through the decade—the gap narrows in the projection from spending restraint, not revenue. Ottawa's plan reaches an operating surplus by 2028-29, with issuance planned at a record—but the Parliamentary Budget Officer cannot verify the surplus because Ottawa has not disclosed its capital classifications. Debt holds near 41% of GDP on the government's plan, 42.5% on the watchdog's—and the watchdog sees the carrying cost climbing to roughly thirteen cents per revenue dollar by 2030-31.",
    },
    abstractCitations: [
      ...
      { phrase: "issuance planned at a record", source: "pipeline:frt_issuance_flow_total", note: "Materialized slot: FY2025-26 plan total $612B vs prior series peak $590B (FY2020-21 actual). Plan-attributed superlative per §4.1k — outturn unpublished." },
      ...
      { phrase: "has not disclosed its capital classifications", source: "card:pbo_seu_anchor_assessment_may2026", note: "Same card: 'no additional insights on the definitions used for classification under the framework were provided.'" },
      ...
      { phrase: "roughly thirteen cents per revenue dollar by 2030-31", source: "card:pbo_efo_june2026_debt_gdp", note: "Same card: debt service ratio 10.5% (2024-25) / 10.6% (2025-26) rising to 13.1% by 2030-31. 'Roughly thirteen cents' rounds true. PBO-attributed in prose." },
    ],
  },
  {
    slug: "housing",
