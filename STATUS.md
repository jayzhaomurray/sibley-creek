...
- **Inflation prose redraft: fact-check gate 1 done, plates 1-4 PASSED, plate-5 caught a real bug.** Fact-checker verified every number in plates 1-4 + header/tile against the refreshed pipeline data (all correct) and promoted the 3 flagged claims (ceasefire/gasoline, World Cup tourism, $14/barrel oil) to verified cards against the commentary PDF. But plate-5 (inflation expectations) had cited stale Q1 2026 data ("expectations never moved") when the pipeline already had Q2 2026 sitting in `data/raw/*` - I independently confirmed via bankofcanada.ca that the Q2 BOS/CSCE results were officially released **2026-07-06** (2 weeks ago, not a preview), so this isn't a vintage-ambiguity call, it's just wrong. Real Q2 story: 5Y consumer expectations rose to 3.4% (from 3.02%), BOS share of firms expecting inflation >3% jumped to 44% (from 11%) - both driven by the same reignited Middle East conflict / oil-shock concerns already framed elsewhere on the page. Backward-looking CPI cooled while forward-looking expectations moved the other way - a real tension, not something to paper over. **Writer dispatched to rewrite plate-5 only**; plates 1-4 stay as fact-checked. Once plate-5 clears a narrow re-check, the whole page goes to style-editor then surface-fit.
- **Follow-ups:** (1) confirm tomorrow's build-monthly run is green; (2) finish the inflation 3-gate loop and ship; (3) above is the recovered June-July narrative - see the note at the top on completeness.
