...
- **Follow-ups:** (1) await backend-engineer's CI root-cause + fix; (2) await writer's inflation redraft, then run it through the 3 gates and ship; (3) below is the recovered June-July narrative - see the note above on completeness.
